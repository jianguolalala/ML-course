...
figure, subfigs = plt.subplots(2, 4, figsize=(16, 10), tight_layout=True, dpi=100,
...
def plot_ex1(mu0, Sigma0, mu1, Sigma1, phi, fig_title, pos):
    ...
    threshold = diff_sorted[len(diff_sorted) // 250]
    ...
    t = np.concatenate([mu0, mu1], axis=1)
    fig.plot(t[0], t[1], '*', color='yellow', markersize=10)
